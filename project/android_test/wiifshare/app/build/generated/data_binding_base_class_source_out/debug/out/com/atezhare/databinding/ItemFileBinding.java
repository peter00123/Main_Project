...
public final class ItemFileBinding implements ViewBinding {
  ...
  private ItemFileBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnRemove,
  ...
  public static ItemFileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFileBinding((MaterialCardView) rootView, btnRemove, ivFileIcon, tvFileName,
          tvFileSize);
    }
