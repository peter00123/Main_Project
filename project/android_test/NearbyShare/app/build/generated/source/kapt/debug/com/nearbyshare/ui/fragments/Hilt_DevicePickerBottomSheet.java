...
public abstract class Hilt_DevicePickerBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DevicePickerBottomSheet() {
    super();
  }

  Hilt_DevicePickerBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DevicePickerBottomSheet_GeneratedInjector) this.generatedComponent()).injectDevicePickerBottomSheet(UnsafeCasts.<DevicePickerBottomSheet>unsafeCast(this));
    }
  }
