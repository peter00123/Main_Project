...
public abstract class Hilt_TransferFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TransferFragment() {
    super();
  }

  Hilt_TransferFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransferFragment_GeneratedInjector) this.generatedComponent()).injectTransferFragment(UnsafeCasts.<TransferFragment>unsafeCast(this));
    }
  }
