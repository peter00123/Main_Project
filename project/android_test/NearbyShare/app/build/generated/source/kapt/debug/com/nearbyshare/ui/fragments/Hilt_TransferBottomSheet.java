...
public abstract class Hilt_TransferBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TransferBottomSheet() {
    super();
  }

  Hilt_TransferBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransferBottomSheet_GeneratedInjector) this.generatedComponent()).injectTransferBottomSheet(UnsafeCasts.<TransferBottomSheet>unsafeCast(this));
    }
  }
