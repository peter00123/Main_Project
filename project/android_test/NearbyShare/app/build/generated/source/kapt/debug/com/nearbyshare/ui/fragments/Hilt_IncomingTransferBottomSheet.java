...
public abstract class Hilt_IncomingTransferBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IncomingTransferBottomSheet() {
    super();
  }

  Hilt_IncomingTransferBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IncomingTransferBottomSheet_GeneratedInjector) this.generatedComponent()).injectIncomingTransferBottomSheet(UnsafeCasts.<IncomingTransferBottomSheet>unsafeCast(this));
    }
  }
